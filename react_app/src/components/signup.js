...
function SignUpForm(props){
    ...
    const [val_email, setVal_email] = useState('');
    const [val_password, setVal_password] = useState('');
    const [val_con_password, setVal_con_password] = useState('');
    function updateValue_username(e){
        console.log(e);
        setVal_name(e.target.value);
    }
    function updateValue_email(e){
        console.log(e);
        setVal_email(e.target.value);
    }
    function updateValue_password(e){
        console.log(e);
        setVal_password(e.target.value);
    }
    function updateValue_con_password(e){
        console.log(e);
        setVal_con_password(e.target.value);  
    }
    function api(){
    ...
    return (
        <div>
            ...
            <label>
                Email:
                <input type='email' value={val_email} onChange={updateValue_email}/>
            </label>
            <label>
                Password:
            ...
            <label>
                confirm Password:
                <input type='password' value={val_password} onChange={updateValue_con_password}/>
            </label>
